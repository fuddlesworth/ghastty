...
/// Whether backend `b`'s build deps should be linked/generated.
/// Exactly one renderer backend is compiled per build, chosen by
/// `-Drenderer=`, so this is simply that backend.
